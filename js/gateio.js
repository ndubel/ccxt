    ...
    async fetchCurrencies (params = {}) {
        ...
        for (let i = 0; i < coins.length; i++) {
            ...
            for (let j = 0; j < ids.length; j++) {
                ...
                const withdrawDisabled = this.safeInteger (currency, 'withdraw_disabled', 0);
                const depositDisabled = this.safeInteger (currency, 'deposit_disabled', 0);
                const tradeDisabled = this.safeInteger (currency, 'trade_disabled', 0);
